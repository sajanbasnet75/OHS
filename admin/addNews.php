...
<form action="" method="POST" enctype="multipart/form-data" role="form">
 <input type="text" required placeholder="Author Name" name="author_name" ><br>
	<label for="image"> Choose Image of the news:</label>
        <input type="file" name="news_img_file" required ><br>
 <input type="textarea" placeholder="Title of news " required name="title"><br>
<br>
...
if (isset($_POST['submit'])){
	if(isset($_FILES['news_img_file']) && isset($_POST['news_txt_file']) && isset($_POST['author_name']) && isset($_POST['date'])&& isset($_POST['title'])) {
        $author_nam=$_POST['author_name'];
        $date=$_POST['date'];
        $title=$_POST['title']; 
...
$query="INSERT INTO news (author,image,title,date,detail) VALUES('$author_nam','$new_img_name','$title','$date','$news_details')";

...
?>
       <div class="container banner-content " >
        ...
        <div class="row banner-choices container-fluid" >
            <a href="appointment.php" class="opt1"> <div class="col-sm-2 col-xs-6  choices1 pull-left" id="choice-mob">
          ...
          <a href="report.php"><div class="col-sm-2 col-xs-6  choices1 pull-right" id="choice-mob">
                     <div class="icon-main" id="icon-mob"><img src="../images/health-records.png"alt="icon" class="img-responsive icon-pic" id="pic-mob"></div> </br> </br> 
                        <button type="button" class="btn btn-primary" >Upload Records</button>
            </div></a>

           <a href="#"><div class="col-sm-2 col-xs-6  choices1 pull-left" id="choice-mob">
                     <div class="icon-main" id="icon-mob"><img src="../images/video.png"alt="icon" class="img-responsive icon-pic" id="pic-mob"></div> </br> </br> 
                       <button type="button" class="btn btn-primary" >Upload Videos</button>

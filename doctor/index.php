...
?>
  <div class="container banner-content " >
        ...
        <div class="row banner-choices container-fluid" >
            <a href="report.php" class="opt1"> <div class="col-sm-2 col-xs-12  choices1 pull-left" id="choice-mob">
                  <div class="icon-main" id="icon-mob"><img src="../images/booking.png"alt="booking" class="img-responsive icon-pic" id="pic-mob" ></div> </br> </br> 
                   <button type="button" class="btn btn-primary"  >My Appointment</button>
            </div> </a>
           
          <a href="docprofile.php"><div class="col-sm-2 col-xs-12  choices1 pull-right" id="choice-mob">
                     <div class="icon-main" id="icon-mob"><img src="../images/find-doctor.png"alt="icon" class="img-responsive icon-pic" id="pic-mob"></div> </br> </br> 
           ...
           <a href="../video.php"><div class="col-sm-2 col-xs-12  choices1 pull-left" id="choice-mob">
             ...
             <a href="ask-a-question.php"><div class="col-sm-2 col-xs-12  choices1 pull-right" id="choice-mob">
                <div class="icon-main" id="icon-mob"><img src="../images/ask.png"alt="icon" class="img-responsive icon-pic" id="pic-mob"></div> </br> </br> 
                  <button type="button" class="btn btn-primary" >Asked question</button>
            </div></a>
       </div>     
    </div>
